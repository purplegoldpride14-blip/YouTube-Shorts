...
>
> Visuals: 1. Still images (7 beats at 4s each/28s total if no voice-over, or one beat per sentence of the script if there's a voice-over)   2. Motion clips (5 beats, native spoken audio via Gemini Omni Flash)
